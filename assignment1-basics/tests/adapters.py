...
from cs336_basics.model import linear,embedding,silu,softmax,cross_entropy,rmsnorm,swiglu,scaled_dot_product_attention,multihead_self_attention,rope,multihead_self_attention_with_rope
from cs336_basics.model import transformer_block,transformer_lm,get_batch,gradient_clipping,AdamW
from cs336_basics.model import get_lr_cosine_schedule,save_checkpoint,load_checkpoint,Tokenizer,train_bpe
def run_linear(
    d_in: int,
    d_out: int,
...
def run_multihead_self_attention(
    ...
    """
    return multihead_self_attention(d_model,
num_heads,
q_proj_weight,
k_proj_weight,
v_proj_weight,
...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    return multihead_self_attention_with_rope(d_model,num_heads,max_seq_len,theta,q_proj_weight,k_proj_weight,
